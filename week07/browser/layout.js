...
function layout(element){
    ...
    if(elementStyle.display !== "flex") //元素没有flex属性的过滤掉
        return ;
    
    var items = element.children.filter(e => e.type === 'element');//文本节点过滤掉
    ...
    for (var i=0; i < items.length; i++){
     ...
     flexLines.forEach(function (items){
        ...
        if(flexTotal > 0) {
            ...
            if(style.justifyContent === 'sapce-between') {
