...
am__v_lt_0 = --silent
am__v_lt_1 = 
libgif_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
...
am__v_CCLD_1 = 
SOURCES = $(libgif_la_SOURCES)
DIST_SOURCES = $(libgif_la_SOURCES)
...
libgif.la: $(libgif_la_OBJECTS) $(libgif_la_DEPENDENCIES) $(EXTRA_libgif_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libgif_la_LINK) -rpath $(libdir) $(libgif_la_OBJECTS) $(libgif_la_LIBADD) $(LIBS)
